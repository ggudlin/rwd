$(document).ready(function () {
    ...
    $(".gadget").on("click", function () { $("#sectiongadgets").hide(); $("#sectiongadgetdetail").show(); });
            ...
            success: function (data, status) {
                ...
                $.each(data, function (i, item) {
                    ...
                    if (j != item.naziv) {
                        ...
                        formatiraniHTML = formatiraniHTML + '<div class="col-md-12"><div class="mojitem clearfix" data-partneriid="' + item.partneriid + '" >'
